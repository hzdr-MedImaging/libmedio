...
class CPhilipsSubHeaderImage : public CPhilipsSubHeader
{
  public:
    ...
    long card_fr_time() const;
    long card_high_rr() const;
    long card_low_rr() const;
    long card_tr_time() const;
    ...
    float pix_spacing(const short i) const;
    ...
    void setCard_fr_time(const long card_fr_time);
    void setCard_high_rr(const long card_high_rr);
    void setCard_low_rr(const long card_low_rr);
    void setCard_tr_time(const long card_high_rr);
    ...
    void setPix_spacing(const short i, const float pix_spacing);
    ...
    void setMidtim(const long midtim);
