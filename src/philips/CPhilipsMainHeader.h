...
class CPhilipsMainHeader : public CMedIOHeader
{
  public:
    ...
    enum Byte_Order {BYTEORDER_BIGENDIAN = 0, BYTEORDER_LITTLEENDIAN};
    ...
    Byte_Order list_byte_ord() const;
    ...
    const char* dep_aqprotocol_name() const;
    ...
    float positron_fraction() const;
    short image_org() const;
    short pulmo_trig_of() const;
    ...
    bool mr_valid() const;
    unsigned char coil_type(const short i) const;
    const char* ref_raw_data_series_inst_uid() const;
    const char* pet_software_version() const;
    unsigned char num_tile_rings() const;
    unsigned char num_detector_modules() const;
    unsigned char num_tiles_per_module_row() const;
    float X_tile_gap() const;
    float Z_tile_gap() const;
    short crystal_type() const;
    short psf1() const;
    short psf1_iter() const;
    float psf1_regularization() const;
    short psf2() const;
    short psf2_iter() const;
    float gaussian_kernel() const;
    const char* acqprotocol_name() const;
    unsigned short coinc_half_window_bins() const;
    const char* isotope_name() const;
    const char* isotope_code_value() const;
    const char* isotope_coding_scheme_designator() const;
    const char* isotope_coding_scheme_version() const;
    const char* isotope_code_meaning() const;
    const char* radiopharm_code_value() const;
    const char* radiopharm_coding_scheme_designator() const;
    const char* radiopharm_coding_scheme_version() const;
    const char* radiopharm_code_meaning() const;
    ...
    void setList_byte_ord(const Byte_Order iOrder);
    ...
    void setDep_isotop(const Isotope isotop);
    ...
    void setDep_Aqprotocol_name(const char* str);
    ...
    void setDep_pharm(const Pharm_Type pharm);
    ...
    void setDep_abundance(const short abundance);
    ...
    void setPositron_fraction(const float fraction);
    void setImage_org(const short value);
    void setPulmo_trig_of(const short value);
    ...
    void setRef_phys(const char* str);
    void setStudy_id(const char* str);
    void setPt_tbl_vers(const short value);
    ...
    void setDmanuf_model(const char* str);
    void setDimg_type(const char* str);
    ...
    void setOperator_name(const char* str);
    ...
    void setCoil_type(const short i, const unsigned char type);
    void setRef_raw_data_series_inst_uid(const char *str);
    void setPet_software_version(const char *str);
    void setNum_tile_rings(const unsigned char value);
    void setNum_detector_modules(const unsigned char value);
    void setNum_tiles_per_module_row(const unsigned char value);
    void setX_tile_gap(const float value);
    void setZ_tile_gap(const float value);
    void setCrystal_type(const short value);
    void setPsf1(const short value);
    void setPsf1_iter(const short value);
    void setPsf1_regularization(const short value);
    void setPsf2(const short value);
    void setPsf2_iter(const short value);
    void setGaussian_kernel(const float value);
    void setAcqprotocol_name(const char *str);
    void setCoinc_half_window_bins(unsigned short value);
    void setIsotope_name(const char *str);
    void setIsotope_code_value(const char *str);
    void setIsotope_coding_scheme_designator(const char *str);
    void setIsotope_coding_scheme_version(const char *str);
    void setIsotope_code_meaning(const char *str);
    void setRadiopharm_code_value(const char *str);
    void setRadiopharm_coding_scheme_designator(const char *str);
    void setRadiopharm_coding_scheme_version(const char *str);
    void setRadiopharm_code_meaning(const char *str);
