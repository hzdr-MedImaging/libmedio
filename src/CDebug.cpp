...
// to get a unique Thread id we normally use pthread_self(). But as some OS, like
// MacOSX doesn't just return a integer identifier we use a general macros
#if defined(__MACH__) // for OSX
#define THREAD_ID						(((unsigned long)pthread_self())%1000)
#else
...
#define THREAD_PREFIX				std::setw(THREAD_WIDTH) << std::setfill('0') << std::hex\
														<< THREAD_ID << ": "
#define THREAD_PREFIX_COLOR	ANSI_ESC_BG << THREAD_ID%6 << "m" << std::setw(THREAD_WIDTH) \
														<< std::setfill('0') << std::hex << THREAD_ID << ":" \
														<< ANSI_ESC_CLR << " "
...
//! creates one.
//! 
//! @return      pointer to current instance of CDebug
////////////////////////////////////////////////////////////////////////////////
CDebug* CDebug::m_pSingletonInstance = 0; 
CDebug* CDebug::instance()
{
	if(m_pSingletonInstance == 0)
	{
		m_pSingletonInstance = new CDebug();
	}
...
//  Constructor: CDebug
//! 
//! Construct a CDebug object.
//! 
////////////////////////////////////////////////////////////////////////////////
CDebug::CDebug(Level dLevel)
...
////////////////////////////////////////////////////////////////////////////////
void CDebug::Enter(const int c, const char *file, long line, const char *function)
{
...
////////////////////////////////////////////////////////////////////////////////
void CDebug::Leave(const int c, const char *file, int line, const char *function)
{
	// first we check if need to process this debug message or not,
	// depending on the currently set debug level
	if((m_CurDebugLevel & c) == 0) return;
	
	if(m_IdentLevel[pthread_self()] > 0) m_IdentLevel[pthread_self()]--;
...
////////////////////////////////////////////////////////////////////////////////
void CDebug::Return(const int c, const char *file, int line,
...
////////////////////////////////////////////////////////////////////////////////
void CDebug::ShowValue(const int c, long value, int size, 
...
////////////////////////////////////////////////////////////////////////////////
void CDebug::ShowPointer(const int c, void *pointer, const char *name,
...
////////////////////////////////////////////////////////////////////////////////
void CDebug::ShowString(const int c, const char *string,
												const char *name, const char *file, long line)
{
	// first we check if need to process this debug message or not,
	// depending on the currently set debug level
...
////////////////////////////////////////////////////////////////////////////////
void CDebug::ShowMessage(const int c, const char *string,
												 const char *file, long line)
{
	// first we check if need to process this debug message or not,
	// depending on the currently set debug level
...
////////////////////////////////////////////////////////////////////////////////
void CDebug::StartClock(const int c, const char *string,
												const char *file, long line)
{
	// first we check if need to process this debug message or not,
	// depending on the currently set debug level
...
////////////////////////////////////////////////////////////////////////////////
void CDebug::StopClock(const int c, const char *string,
											 const char *file, long line)
{
	// first we check if need to process this debug message or not,
	// depending on the currently set debug level
...
////////////////////////////////////////////////////////////////////////////////
void CDebug::dprintf_header(const int c, const int g, const char *file,
...
//! @param       ... a vararg list of parameters.
////////////////////////////////////////////////////////////////////////////////
void CDebug::dprintf(const int c, const int g, const char *fmt, ...)
{
	// first we check if need to process this debug message or not,
	// depending on the currently set debug level
	if((m_CurDebugLevel & c) == 0) return;
