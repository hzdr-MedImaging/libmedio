...
static void compareECAT7ImageSubHeaders(CECATSubHeader* subHeader1, CECATSubHeader* subHeader2)
{
	...
	if(sh1->zfilter_Cutoff() != sh2->zfilter_Cutoff())
		cout << "     ZFILTER_CUTOFF..........: '" << sh1->zfilter_Cutoff() << "' != '" << sh2->zfilter_Cutoff() << "'" << endl;
	if(sh1->zfilter_Resolution() != sh2->zfilter_Resolution())
		cout << "     ZFILTER_RESOLUTION......: '" << sh1->zfilter_Resolution() << "' != '" << sh2->zfilter_Resolution() << "'" << endl;
	if(sh1->zfilter_Code() != sh2->zfilter_Code())
		cout << "     ZFILTER_CODE............: '" << sh1->zfilter_Code() << "' != '" << sh2->zfilter_Code() << "'" << endl;
	if(sh1->zfilter_Order() != sh2->zfilter_Order())
		cout << "     ZFILTER_ORDER...........: '" << sh1->zfilter_Order() << "' != '" << sh2->zfilter_Order() << "'" << endl;
